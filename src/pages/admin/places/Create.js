...
//title page
    document.title = "Tambah Event/Budaya - Administrator Event Wisata";
                    ...
                    <div className="col-12">
                        <div className="card border-0 rounded shadow-sm border-top-success">
                            <div className="card-header">
                                <span className="font-weight-bold"><i className="fa fa-map-marked-alt"></i> TAMBAH EVENT WISATA DAN KEGIATAN KEBUDAYAAN</span>
                            </div>
                            <div className="card-body">
                                <form onSubmit={storePlace}>
                                    ...
                                    <div className="mb-3">
                                        ...
                                        <input type="text" className="form-control" value={title} onChange={(e) => setTitle(e.target.value)} placeholder="Masukkan Judul Kegiatan"/>
                                    </div>
                                    {validation.title && (
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-md-6">
                                        <div className="mb-3">
                                        <label className="form-label fw-bold">Waktu Kegiatan</label>
					<input type="text" className="form-control" value={office_hours} onChange={(e) => setOfficeHours(e.target.value)} placeholder="Masukkan waktu kegiatan "/>  
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="mb-3">
                                            ...
                                            <input type="text" className="form-control" value={website} onChange={(e) => setWebsite(e.target.value)} placeholder="Masukkan Website Kegiatan"/>
                                        </div>
                                        {validation.website && (
                                            <div className="alert alert-danger">
                                                {validation.title[0]}
                                    ...
                                    <div className="mb-3">
                                        ...
                                        <textarea className="form-control" rows="3" value={address} onChange={(e) => setAddress(e.target.value)} placeholder="Masukkan Alamat"></textarea>
                                    </div>
                                    {validation.address && (
                                        <div className="alert alert-danger">
